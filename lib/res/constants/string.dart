...
const kAgreeTienext = "By clicking Next, I agree to Tienext ";
...
const kEmailResetPass = "Enter the email of the account you are\n        trying to reset password for";
const kPhoneResetPass = "Enter the phone number of the account you \n            are trying to reset password for";
...
const kEnterOtpSent = 'Enter the OTP sent to your mobile number\n or email address to change the password';

const kOneTimePass = 'An one-time-password has been sent to\nyour phone number';
const kRequirements = 'Requirements you might like';
const kView = 'View';
const kGenerated = 'The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.';
